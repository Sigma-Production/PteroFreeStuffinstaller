...
const Code = styled.code`${tw`font-mono py-1 px-2 bg-theme-main rounded text-sm inline-block`}`;
        ...
        <GreyRowBox $hoverable={false} css={tw`flex-wrap md:flex-nowrap mt-2`}>
            ...
            <div css={tw`mt-4 w-full md:mt-0 md:flex-1 md:w-auto`}>
                <InputSpinner visible={loading}>
                    <Textarea
                        css={tw`bg-theme-main hover:border-neutral-600 border-transparent`}
                        placeholder={'Notes'}
