...
import { faExternalLinkAlt, faGasPump, faGem, faHeart } from '@fortawesome/free-solid-svg-icons';
        ...
        <React.Fragment key={'server-router'}>
            ...
            {(!uuid || !id) ?
                ...
                <>
                    ...
                    <ProSidebar css={tw`flex-shrink`}>
                        <Menu iconShape="square">
                                <MenuItem><NavLink to={`${match.url}`} exact>Console</NavLink></MenuItem>
                                <Can action={'file.*'}>
                                    <MenuItem><NavLink to={`${match.url}/files`}>File Manager</NavLink></MenuItem>
                                </Can>
                                <Can action={'database.*'}>
                                    <MenuItem><NavLink to={`${match.url}/databases`}>Databases</NavLink></MenuItem>
                                </Can>
                                <Can action={'schedule.*'}>
                                    <MenuItem><NavLink to={`${match.url}/schedules`}>Schedules</NavLink></MenuItem>
                                </Can>
                                <Can action={'user.*'}>
                                    <MenuItem><NavLink to={`${match.url}/users`}>Users</NavLink></MenuItem>
                                </Can>
                                <Can action={'backup.*'}>
                                    <MenuItem><NavLink to={`${match.url}/backups`}>Backups</NavLink></MenuItem>
                                </Can>
                                <Can action={'allocation.*'}>
                                    <MenuItem><NavLink to={`${match.url}/network`}>Network</NavLink></MenuItem>
                                </Can>
                                <Can action={'startup.*'}>
                                    <MenuItem><NavLink to={`${match.url}/startup`}>Startup</NavLink></MenuItem>
                                </Can>
                                <Can action={['settings.*', 'file.sftp']} matchAny>
                                    <MenuItem><NavLink to={`${match.url}/settings`}>Settings</NavLink></MenuItem>
                                </Can>
                                {rootAdmin &&
                                    <MenuItem>
