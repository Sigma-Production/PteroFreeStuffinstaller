...
wget https://raw.githubusercontent.com/Sigma-Production/PteroFreeStuffinstaller/V1.10.1/resources/Sidebar/ServerRouter.css
rm -r ServerRouter.tsx
wget https://raw.githubusercontent.com/Sigma-Production/PteroFreeStuffinstaller/V1.10.1/resources/Sidebar/ServerRouter.tsx
#clear
cd /var/www/pterodactyl
