...
const CronBox = ({ title, value }: { title: string; value: string }) => (
    <div css={tw`bg-theme-main-2 rounded p-3`}>
    ...
    return (
        <PageContentBlock title={'Schedules'}>
            ...
            {!schedule || isLoading ?
                ...
                :
                <>
                    <ScheduleCronRow cron={schedule.cron} css={tw`sm:hidden bg-theme-main-2 rounded mb-4 p-3`}/>
                    <div css={tw`rounded shadow`}>
                        <div css={tw`sm:flex items-center bg-theme-main-2 p-3 sm:p-6 border-b-4 border-theme-main-2 rounded-t`}>
                            <div css={tw`flex-1`}>
                                <h3 css={tw`flex items-center text-neutral-100 text-2xl`}>
                                    {schedule.name}
                                    {schedule.isProcessing ?
                                        <span
                                            css={tw`flex items-center rounded-full px-2 py-px text-xs ml-4 uppercase bg-theme-main text-white`}
                                        >
                        ...
                        <div css={tw`bg-theme-main-2 rounded-b`}>
