...
echo "4. Install Animated Background theme (unsuported)"
...
if [ $choice == "4" ]
    ...
    bash <(curl -sSL https://raw.githubusercontent.com/finnie2006/PteroFreeStuffinstaller/old/resources/mvb/install.sh)
fi
if [ $choice == "5" ]
    then
    echo "Installing Animatedlogin...."
