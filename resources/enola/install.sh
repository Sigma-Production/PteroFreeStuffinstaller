...
rm -rf main.css
echo "@import url('https://oreokitten.github.io/latest/Enola/user.css')" >> /var/www/pterodactyl/resources/scripts/main.css
rm -rf index.tsx
...
wget https://raw.githubusercontent.com/DeveloperNeon/ptero-1.0-theme-install/main/resources/enola/admin.blade.php
npm install yarn -g
yarn install
